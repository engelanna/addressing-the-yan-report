...
In September 2020, the above claimed to **be** scientific evidence for SARS-CoV-2 being an engineered bioweapon :raised_eyebrow: Despite it not being peer-reviewed, Zenodo granted the report some credibility by assigning a Digital Object Identifier (DOI).
...
<br>Critical thinking only requires that the core claim be verified - when that turns out to be false, everything derived from it automatically becomes false as well :woman_shrugging: What was the postulate, then, that sufficed for its publishers to seek asylum abroad?
...
Two restriction enzymes (sequences bacteria use to slash virii to bits, repurposed by humans to glue parts of different genomes together): [EcoRI](https://www.neb.com/products/r0101-ecori#Product%20Information) and [BstEII](https://www.neb.com/products/r0162-bsteii#Product%20Information). According to Yan et al, they allowed for maliciously inserting a large-mammal-targetting protein.
...
As far as genomes go, this one's really tiny - a hundred thousand times shorter than a human one. A single human cell's genome would eat up 3.3 GB of your hard drive, and your body has ~37 trillion cells :scream_cat:.
