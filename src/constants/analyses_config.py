...
ANALYSES_CONFIG = OpenStruct(
    martin_and_mercola=OpenStruct(
        diagram_annotation="ORF = Open Reading Frame (region between start & end sites of RNA>protein translation",
        diagram_title="SARS-CoV-1 (accession NC_004718.3) genes",
