...
from src.constants import ANALYSIS_CONFIG
...
genome = SoleSequenceFromFastaFile()(
    ANALYSIS_CONFIG.yan_et_al.sars_cov_2_genome_fasta_path
)
...
[
    ...
    for genomic_range in BuildGenomicRangeList().from_bed_file(
        ANALYSIS_CONFIG.yan_et_al.sars_cov_2_gene_ranges_bed_file_path
    )
]
...
diagram = OverridenGenomeDiagram(ANALYSIS_CONFIG.yan_et_al.diagram_title)
